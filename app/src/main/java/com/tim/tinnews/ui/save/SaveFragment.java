package com.tim.tinnews.ui.save;
...
import com.tim.tinnews.databinding.FragmentSaveBinding;
...
public class SaveFragment extends Fragment {
    ...
    private com.tim.tinnews.ui.save.SaveViewModel viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this, new NewsViewModelFactory(repository)).get(com.tim.tinnews.ui.save.SaveViewModel.class);
        viewModel
                .getAllSavedArticles()
                .observe(
